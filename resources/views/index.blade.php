                    ...
                    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                          <div class="carousel-item active" data-bs-interval="10000">
                            <img src="{{ asset('Carousel_Images/situps.jpg') }}" class="d-block w-100" alt="Workout">
                          </div>
                          <div class="carousel-item" data-bs-interval="2000">
                            <img src="{{ asset('Carousel_Images/stretch.jpg') }}" class="d-block w-100" alt="Workout">
                          </div>
                          <div class="carousel-item">
                            <img src="{{ asset('Carousel_Images/pushups.jpg') }}" class="d-block w-100" alt="Workout">
                          </div>
                        </div>
